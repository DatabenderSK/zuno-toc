...
= 1.0.7 =
* Bezpečnostný audit – sanitácia customAnchors, customLabels, accentColor, fontSize
* Validácia GitHub updater URL
* Escaping na settings stránke podľa WordPress štandardov
